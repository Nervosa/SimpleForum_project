...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_forumuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('system_user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'api', ['ForumUser'])

        # Adding model 'Topic'
        db.create_table(u'api_topic', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 21, 0, 0))),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'api_forumuser')

        # Deleting model 'Topic'
        db.delete_table(u'api_topic')
    ...
    models = {
        u'api.forumuser': {
            ...
            'system_user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'api.post': {
            'Meta': {'object_name': 'Post'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.ForumUser']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 21, 0, 0)'}),
            'number_in_topic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'api.topic': {
            ...
            'op_post': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'auth.group': {
